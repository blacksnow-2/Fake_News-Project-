...
from fake_new.utils.features import normalize_and_clean
...
def read_datapoints(datapath: str) -> List[Dict]:
    with open(datapath) as f:
        ...
        datapoints = [row for row in reader]
    return datapoints


if __name__ == "__main__":
    args = read_args()
    # args automatically converts the hyphens in add_argument to underscores like down below.
